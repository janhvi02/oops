        ...
        while (true) {    //while loop
            ...
            switch (c) {// switch cases
                ...
                case 1:    //if input is 1
                    ...
                    Template.Pallindrome(s); //calling Pallindrome method
                    System.out.println("======================================================");
                    break;
                ...
                case 2: //if input is 2
                    ...
                    s = sc.next();//taking String s as an input from user
                    Template.Pallindrome(s); //calling Pallindrome method
                    Template.evenodd(Integer.parseInt(s)); //calling Even Odd method
                    Template.prime(Integer.parseInt(s)); //calling prime method
                    System.out.println("======================================================");
                    break;
                ...
                case 5: //if input is 5
                    ...
                    Template.checkfun(ss); //calling check function method
                    System.out.println("======================================================");
                    break;
